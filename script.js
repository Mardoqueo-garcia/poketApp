document.getElementById('pokeForm').addEventListener('submit', function(event) {
    ...
    const pokeInput = document.getElementById('pokeInput').value.toLowerCase(); //capturamos el input del usuario
    const apiUrl = `https://pokeapi.co/api/v2/pokemon/${pokeInput}`; //creamos la url para la peticion
